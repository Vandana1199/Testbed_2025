...
PT_Height_Stats_ByStrip["Farm_Coordinates"] = (
    "POLYGON (("
    "-91.442144 37.78772, "
    "-91.442164 37.788076, "
    "-91.442118 37.788786, "
...
def fetch_and_process_farm_data(clipped_df):
    ...
    collection_id = "31eede13-39cc-402d-acd3-d5a7881cbd59"
...
clipped_df = pd.read_csv("wurdack_polygons_with_offsets_ByStrip.csv")
